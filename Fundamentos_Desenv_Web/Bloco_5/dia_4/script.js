...
/*   let preferences = {
    ...
    lineHeight: newHeightLine,
    fontFamily: newFont,
  }

  localStorage.setItem('preferences', JSON.stringify(preferences));
  let preferencias = JSON.parse(localStorage.getItem('preferences'));

window.onload ();
  document.querySelector('body').style.backgroundColor = preferences.color;
  document.querySelector('body').style.color = preferences.fontColor;
  document.querySelector('p').style.fontSize = preferences.fontSize;
  document.querySelector('p').style.lineHeight = preferences.lineHeight;
  document.querySelector('#text').style.fontFamily = preferences.fontFamily; */